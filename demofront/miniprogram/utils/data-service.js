...
function getRiskAssessment(appointmentId) {
  return request({ url: API.RISK_BY_APPOINTMENT(appointmentId) })
}

function getHighRiskList() {
  return request({ url: API.RISK_HIGH })
}

function getAllRiskList() {
  return request({ url: API.RISK_ALL })
}

function reassessRisk(appointmentId) {
  return request({ url: API.RISK_REASSESS(appointmentId), method: 'POST' })
}

function getRiskStoreStatus() {
  return request({ url: API.RISK_STORE_STATUS })
}

function rebuildRiskStore() {
  return request({ url: API.RISK_STORE_REBUILD, method: 'POST' })
}
...
module.exports = {
  ...
  lookupHost, getMyAppointments, createAppointment, cancelAppointment, restoreAppointment,
  ...
  getRiskAssessment, getHighRiskList, getAllRiskList, reassessRisk, getRiskStoreStatus, rebuildRiskStore,
